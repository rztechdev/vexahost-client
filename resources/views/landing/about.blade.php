        <!-- Tentang Portal (Hero) -->
        <section id="tentang" class="max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-12 sm:py-20 border-t border-zinc-200 dark:border-zinc-800/80 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center relative overflow-hidden">
            ...
            <div class="lg:col-span-6 space-y-5 sm:space-y-6 text-left">
                ...
                <p class="text-sm sm:text-base lg:text-lg text-zinc-650 dark:text-zinc-400 leading-relaxed max-w-xl">
                    Tinggalkan koordinasi yang terfragmentasi. VexaHost Client menyatukan pelacakan kepatuhan janji layanan (SLA), delegasi tugas tim teknis, dan repositori dokumen proyek dalam satu ekosistem operasional terintegrasi.
                </p>
