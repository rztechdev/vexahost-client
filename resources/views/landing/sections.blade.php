        ...
        <section id="fitur" class="py-12 sm:py-20 border-t border-zinc-200 dark:border-zinc-800/80 bg-zinc-100/20 dark:bg-zinc-950/10">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="text-center mb-10 sm:mb-16 space-y-2">
                    <h2 class="text-xs font-mono font-bold text-[#5c8a0f] dark:text-[#BAFF39] tracking-widest uppercase">Kapasitas Sistem</h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <!-- Feature Card 1 -->
                    <div class="bg-white dark:bg-zinc-900 p-6 sm:p-8 rounded-2xl border border-zinc-200 dark:border-zinc-800 hover:border-[#BAFF39]/50 dark:hover:border-[#BAFF39]/40 hover:-translate-y-1 transition-all duration-300 shadow-sm hover:shadow-md">
                        <div class="w-11 h-11 sm:w-12 sm:h-12 bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-xl flex items-center justify-center text-[#5c8a0f] dark:text-[#BAFF39] mb-5 sm:mb-6">
                    ...
                    <div class="bg-white dark:bg-zinc-900 p-6 sm:p-8 rounded-2xl border border-zinc-200 dark:border-zinc-800 hover:border-[#BAFF39]/50 dark:hover:border-[#BAFF39]/40 hover:-translate-y-1 transition-all duration-300 shadow-sm hover:shadow-md relative overflow-hidden">
                        <div class="absolute top-0 right-0 w-24 h-24 sm:w-28 sm:h-28 bg-[#BAFF39]/10 rounded-full blur-xl"></div>
                        <div class="w-11 h-11 sm:w-12 sm:h-12 bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-xl flex items-center justify-center text-[#5c8a0f] dark:text-[#BAFF39] mb-5 sm:mb-6 relative z-10">
        ...
        <section id="rbac" class="py-12 sm:py-20 border-t border-zinc-200 dark:border-zinc-800/80">
            <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="text-center mb-10 sm:mb-12">
                    <h2 class="text-xs font-mono font-bold text-[#5c8a0f] dark:text-[#BAFF39] tracking-widest uppercase mb-2">Keamanan & Kejelasan Tanggung Jawab</h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-12 gap-6 sm:gap-8 items-start">
                    ...
                    <div class="md:col-span-4 flex flex-row md:flex-col gap-2 overflow-x-auto no-scrollbar pb-3 md:pb-0 scroll-smooth -mx-4 px-4 md:mx-0 md:px-0">
                        ...
                        <button @click="activeRole = 'pm'"
                                :class="activeRole === 'pm' ? 'bg-lime-50/80 dark:bg-lime-950/30 text-[#4d750c] dark:text-[#BAFF39] border-[#BAFF39] font-bold' : 'bg-transparent text-zinc-500 hover:bg-zinc-150 dark:hover:bg-zinc-900/50 border-transparent'"
                        ...
                        <button @click="activeRole = 'tech'"
                                :class="activeRole === 'tech' ? 'bg-lime-50/80 dark:bg-lime-950/30 text-[#4d750c] dark:text-[#BAFF39] border-[#BAFF39] font-bold' : 'bg-transparent text-zinc-500 hover:bg-zinc-150 dark:hover:bg-zinc-900/50 border-transparent'"
                                class="flex items-center gap-2.5 px-4 py-3 rounded-xl border-l-2 text-xs sm:text-sm text-left transition-all shrink-0">
                        ...
                        <button @click="activeRole = 'client'"
                                :class="activeRole === 'client' ? 'bg-lime-50/80 dark:bg-lime-950/30 text-[#4d750c] dark:text-[#BAFF39] border-[#BAFF39] font-bold' : 'bg-transparent text-zinc-500 hover:bg-zinc-150 dark:hover:bg-zinc-900/50 border-transparent'"
                                class="flex items-center gap-2.5 px-4 py-3 rounded-xl border-l-2 text-xs sm:text-sm text-left transition-all shrink-0">
                        ...
                        <button @click="activeRole = 'ceo'"
                                :class="activeRole === 'ceo' ? 'bg-lime-50/80 dark:bg-lime-950/30 text-[#4d750c] dark:text-[#BAFF39] border-[#BAFF39] font-bold' : 'bg-transparent text-zinc-500 hover:bg-zinc-150 dark:hover:bg-zinc-900/50 border-transparent'"
                                class="flex items-center gap-2.5 px-4 py-3 rounded-xl border-l-2 text-xs sm:text-sm text-left transition-all shrink-0">
                    ...
                    <div class="md:col-span-8 bg-white dark:bg-zinc-900 p-5 sm:p-8 rounded-2xl border border-zinc-200 dark:border-zinc-800 shadow-sm min-h-[260px] transition-all">
                        ...
                        <div x-show="activeRole === 'pm'" class="space-y-3 sm:space-y-4" x-transition:enter="transition ease-out duration-200">
                            <div class="flex items-center gap-2.5">
                                <span class="p-2 rounded-lg bg-lime-50 dark:bg-lime-950/30 text-[#5c8a0f] dark:text-[#BAFF39] shrink-0">
                            ...
                            <div class="pt-3.5 border-t border-zinc-100 dark:border-zinc-800/60 grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
                                <div class="flex items-center gap-2 text-[11px] sm:text-xs text-zinc-600 dark:text-zinc-350">
                                    <span class="material-symbols-outlined text-[#6ca413] dark:text-[#BAFF39] text-[16px] sm:text-[18px] shrink-0">check_box</span>
