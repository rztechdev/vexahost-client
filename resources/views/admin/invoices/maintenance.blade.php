        ...
        <div style="display: flex; gap: 8px;">
            ...
            @if($subscription->id)
                <form id="formSendWaMaintenance" action="{{ route('admin.invoices.maintenance.send-wa', $subscription->id) }}" method="POST" style="display: inline; margin: 0;">
                    @csrf
                    <button type="button" class="action-btn" onclick="Swal.fire({title:'Konfirmasi',text:'Kirim dokumen PDF Invoice Maintenance ini langsung ke nomor WhatsApp {{ $lead?->kontak_wa }} via VexaHost WA Gateway?',icon:'question',showCancelButton:true,confirmButtonText:'Ya, Kirim',cancelButtonText:'Batal',confirmButtonColor:'#C2410C',cancelButtonColor:'#71717a',reverseButtons:true}).then(r=>{if(r.isConfirmed)document.getElementById('formSendWaMaintenance').submit()})">
                        ...
                        <tr>
                            ...
                            <td style="vertical-align: top; padding-left: 8px;">
                                ...
                                <div style="font-size: 7.5pt; color: #555555; margin-top: 6px; line-height: 1.3;">
                                    Konfirmasi bukti perpanjangan dapat dikirimkan via WhatsApp resmi atau melalui Client Panel.
                                </div>
                            </td>
                        </tr>
                    </table>
